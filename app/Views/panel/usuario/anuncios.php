            ...
            <div class='card mb-3'>
                <div class='row g-0'>
                    ...
                    <div class='col-lg-9 col-xxl-10'>
                        <div class='card-body'>
                            <h6 class='card-title fw-bolder text-success'><?=$nombre?></h6>
                            <div class='row'>
                                <div class="col-sm-8">
                                    <div class='col-sm-12'>
                                        <i class='fas fa-tag' title="categoria"></i> Categoría: <?=$categoria?>
                                    </div>
                                    <div class='col-sm-12'>
                                        <i class='fas fa-hand-holding-usd' title="precio"></i> Precio: S/. <?=$tagprecio?>
                                    </div>

                                    <div class='col-sm-12'>
                                        <i class="fas fa-calendar-alt" title="creado el:"></i> Creado: <?=$fechac?>
                                    </div>
                                    <div class='col-sm-12'>
                                        <i class='fas fa-thermometer-quarter' title="estado"></i> Estado: <span <?=$tooltip_observado?> ><?=$estado?></span> <?=$icon_levanta_obs?> <?=$text_fechad_fin?>
                                    </div>
