...
<div class="card rounded-0">
    ...
    <div class="card-body create_anuncio">
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="form-group pb-2">
                    <label for="nombre" class="mb-2 fw-semibold bg-light d-block"><i class="fas fa-hand-point-right"></i> Título o nombre de tu anuncio <i class="text-secondary texto-size-13">(Evita signos como: comas, guiones, interrogantes, etc)</i></label>
