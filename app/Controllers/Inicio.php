...
class Inicio extends BaseController
{
    ...
    public function busqueda($t = '', $c = '', $u = ''){
        ...
        //echo "<br>$idcategoria -- $idubigeo -- $keyword -- $order -- $page";
    ...
    {   
        if( $this->request->is('get') ){
            ...
            $anuncio = $this->modeloAnuncio->getAnu_idanu($id, [2,4,5]);
    ...
    private function _loginGmail(){
        ...
        $clientID = getenv('CLIENT_ID_GOOGLE');
        $clientSecret = getenv('CLIENT_SECRET');
        $redirectUri = 'http://localhost/anuncios/ingresar';
    ...
    {   
        ...
        $data['title'] = 'Ingresa o Regístrate | '.help_nombreWeb();
